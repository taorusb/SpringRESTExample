...
COPY --from=build /home/gradle/src/build/libs/*.jar /app/SpringRESTExample-0.0.1-SNAPSHOT.jar

ENTRYPOINT ["java", "-XX:+UnlockExperimentalVMOptions", "-XX:+UseCGroupMemoryLimitForHeap", "-Djava.security.egd=file:/dev/./urandom","-jar","/app/SpringRESTExample-0.0.1-SNAPSHOT.jar"]